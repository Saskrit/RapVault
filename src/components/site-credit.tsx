  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="inline-flex items-center rounded-md border border-border bg-background px-2 py-0.5 text-xs font-semibold tracking-wide text-foreground transition hover:border-accent hover:text-accent sm:text-xs"
      >
        Portfolio Website
      </a>
    </p>
